...
import "./styles/Sliderppt17_SeleccionPreguntasParte2.css"

function Sliderppt17_SeleccionPreguntasParte2() {
  ...
  const questions = [
    {
      question: "¿Cuál es un paso esencial durante el alistamiento del área de trabajo para montar un andamio?",
      options: [
        { text: "Colocar carteles visibles con información de los riesgos.", correct: false },
        { text: "Retirar escombros, herramientas y materiales que puedan obstaculizar el montaje.", correct: true },
        { text: "Comprobar que se cuenta con las herramientas adecuadas para el montaje.", correct: false },
      ],
    ...
    {
      question:
        "¿Qué medida se debe tomar para evitar el acceso de personas no autorizadas durante el montaje del andamio?",
      options: [
        { text: "Revisar que las piezas del andamio estén en buen estado.", correct: false },
        { text: "Colocar barreras y señalización de advertencia en el área de montaje.", correct: true },
        { text: "Mantener el área libre de sustancias resbaladizas.", correct: false },
      ],
              ...
              {questionResults.map((result, index) => (
                <p key={index} theme="light" className="text-centrar">
                  ...
                  <span className={result === 1 ? "text-successPSH" : "text-errorPSH"}>
                    {result}/1 respuesta(s) correcta(s)
                  </span>
                </p>
              ))}
            </div>
...
export default Sliderppt17_SeleccionPreguntasParte2
