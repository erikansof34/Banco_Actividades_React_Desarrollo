...
function PreguntasRiesgosTermicosV2() {
        ...
        <div className="bg-white text-[#afafaf] border-[#e0e0e0] md:rounded-lg md:shadow-md mb-[1px] p-4 border rounded-md shadow-md">
          <Paragraph theme="light" className="w-full">
            ...
            <Select
              ...
              isValidated={isValidated}
            />
            , por ejemplo con los productos de limpieza del vehículo y de los equipos que manipulas a diario. ¡Por favor ten mucho cuidado!
          </Paragraph>
          {isValidated && (
            <div
...
export default PreguntasRiesgosTermicosV2;
