...
import "./styles/PreguntasProteccion3.css";
  ...
  return (
        <div className="w-full flex flex-col justify-center items-center ">
          {showQuestions && !showResults && (
            <div className="preguntas_01 w-full flex flex-col items-center justify-center">
          ...
          {showResults && (
            <div className="resultado-container flex flex-col items-center justify-center">
              <p className="text-[#808693] font-bold mb-0">Resultados:</p>
              ...
              {questionResults.map((result, index) => {
                 ...
                 <p className="font-bold text-center text-[#808693]">
                  <span>
                   ({Math.round(
