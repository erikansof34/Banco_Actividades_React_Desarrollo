...
function Slider14_Lista_desplegable_movil() {
  ...
  return (
    <div className="leading-loose">
      <div
        className="bg-white text-[#afafaf] border-[#e0e0e0] md:rounded-lg md:shadow-md mb-[1px] md:m-4 border rounded-md shadow-md"
        style={{ padding: "18px" }}
      >
        <Paragraph theme="light" className="w-full">
          ...
          <Select
            ...
            isValidated={isValidated}
          />
          : Instrucciones sobre cómo montar los equipos y determinar los puntos
          de anclaje adecuados.
          <br />
          c. Conectividad: Orientaciones sobre la conexión segura de los equipos
          de rescate.
          <Select
            className="m-1 border-[#afafaf] border-2  text-[#afafaf] w-64"
            index={2}
...
export default Slider14_Lista_desplegable_movil;
