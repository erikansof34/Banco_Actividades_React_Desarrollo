...
import "./styles/Seleccione_Video_Caso_V2.css"

function Seleccione_Video_Caso_V2() {
    ...
    const question = {
        ...
        options: [
            { text: "En el ambiente de Trabajo.", correct: true },
            { text: "Jornadas Laborales Extensas.", correct: true },
            { text: "Violencia laboral.", correct: false },
            { text: "Liderazgo negativo.", correct: false },
        ],
        correctFeedback: "Muy bien! Has identificado los 2 factores de riesgo que que se relacionan con este caso",
...
export default Seleccione_Video_Caso_V2